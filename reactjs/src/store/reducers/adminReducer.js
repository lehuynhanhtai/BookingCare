...
const adminReducer = (state = initialState, action) =>
{
    switch (action.type)
    {
        ...
        //get TIME
        case actionTypes.FETCH_ALLCODE_SCHEDULE_TIME_SUCCES:
        ...
        case actionTypes.FETCH_REQUITED_DOCTOR_INFOR_SUCCESS:
            state.allRequiredDoctorInfor = action.data;
            return {
                ...state
            }

        case actionTypes.FETCH_REQUITED_DOCTOR_INFOR_FAILED:
